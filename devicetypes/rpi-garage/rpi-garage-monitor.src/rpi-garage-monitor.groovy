    ...
    if (parsedEvent['body'] != null) {
        ...
        parent.getChildDevices().each { child ->
            ...
            if (childUsn == targetUsn) {
            	log.debug "childUSN ${childUsn} equal to Target USN ${targetUsn}"
            	...
            	log.debug "childUSN ${childUsn} not equal to Target USN ${targetUsn}"
            }
...
private subscribeAction(path, callbackPath="") {
	...
	log.debug "SUBSCRIBE ${path} ${ip} NT: upnp:event Second-3600"
