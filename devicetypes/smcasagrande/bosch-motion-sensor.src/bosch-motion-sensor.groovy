/*
 *  Copyright 2016 SmartThings, S. Casagrande 
 *
...
//SO FAR THIS one actually seems to work.
metadata {
	definition (name: "Bosch Motion Sensor", namespace: "smcasagrande", author: "Steve Casagrande", category: "C2") {
...
//		fingerprint inClusters: "0000,0001,0003,000F,0020,0402,0500", outClusters: "0019", manufacturer: "SmartThings", model: "motionv4", deviceJoinName: "Motion Sensor"
        fingerprint profileId: "0104", deviceId: "0402", inClusters: "0000, 0003, 0500, 0020, 0402, 0001, 0B05", outClusters: "0019", manufacturer: "Bosch", model: "ISW-ZPR1-WP13", deviceJoinname: "Bosch Motion Detector"
	}
