 ...
 */
metadata {
	definition (name: "Minimote Button Endpoint", namespace: "kirkbrownOK", author: "Kirk Brown") {
		capability "Actuator"
		capability "Button"
		capability "Sensor"
...
def hold1() {
	sendEvent(name: "button", value: "held", data: "1", descriptionText: "$device.displayName button 1 was held", isStateChange: true)
} 

def push1() {
	sendEvent(name: "button", value: "pushed", data: "1", descriptionText: "$device.displayName button 1 was pushed", isStateChange: true)
}