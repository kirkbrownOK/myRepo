 ...
 */
definition(
	name: "Withings Wakeup via IFTTT",
	namespace: "okpowerman",
	author: "okpowerman",
	description: "Withings sends new Weight Measurement to IFTTT, then IFTTT turns on button tile. When button tile goes on execute home phrase",
...
def rootPage() {
	dynamicPage(name: "rootPage", title: "", install: true, uninstall: true) {
			...
			section {
				href(name: "toSchedulingPage", page: "schedulingPage", title: "Rules For Executing Hello Home Phrase", description: schedulingHrefDescription(), state: schedulingHrefDescription() ? "complete" : "")
			}
...
def schedulingPage() {
	dynamicPage(name: "schedulingPage", title: "Rules For Automatically Dimming Your Lights") {
		...
		section {
            ...
            input "mySwitch", "capability.switch", title: "Execute when Switch turns on", required: false, multiple: true
		}
